...
export default async function RedesignPage({ params }: RedesignPageProps) {
  ...
  return (
    <>
      ...
      <SiteNav brandHref="/" ctaHref="/about" ctaLabel="Về Nét Nút" />
        ...
        <article>
                ...
                <div className="max-w-md self-end md:col-span-4 md:col-start-9">
                  ...
                  <div className="mt-8 grid grid-cols-2 gap-px border border-white/15 bg-white/15">
                    <div className="bg-[#111111] p-4">
                      <p className="font-mono text-xs uppercase tracking-[0.12em] text-muted">Nguồn nội dung</p>
                      <p className="mt-2 text-sm">{project.originalLabel}</p>
                    </div>
                    <div className="bg-[#111111] p-4">
                      <p className="font-mono text-xs uppercase tracking-[0.12em] text-muted">Trạng thái</p>
                      <p className="mt-2 text-sm">Case study minh họa</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="mx-auto max-w-[1500px]">
              <div className="grid gap-12 md:grid-cols-12 md:gap-8">
                <div className="md:col-span-5">
                  <p className="font-mono text-xs uppercase tracking-[0.14em] text-accent">01 / Chẩn đoán</p>
          ...
          <section className="border-y border-white/15 bg-[#111111] px-4 py-20 sm:px-6 md:py-28 lg:px-10">
            <div className="mx-auto max-w-[1500px]">
              <div className="grid gap-12 md:grid-cols-12 md:gap-8">
                <div className="md:col-span-5">
                  <p className="font-mono text-xs uppercase tracking-[0.14em] text-accent">02 / Quyết định</p>
                  <h2 className="mt-5 max-w-[9ch] text-[clamp(3rem,6vw,6rem)] font-semibold leading-[0.86] tracking-[-0.04em]">
                    Dựng lại đường đi.
                  </h2>
                </div>
          ...
          <section className="px-4 py-20 sm:px-6 md:py-28 lg:px-10">
            <div className="mx-auto grid max-w-[1500px] gap-10 border-t border-white/15 pt-6 md:grid-cols-12 md:gap-8">
              <p className="font-mono text-xs uppercase tracking-[0.14em] text-accent md:col-span-3">03 / Ghi chú</p>
          ...
          <section className="border-t border-white/15 px-4 py-20 sm:px-6 md:py-28 lg:px-10">
            <div className="mx-auto flex max-w-[1500px] flex-col gap-8 md:flex-row md:items-end md:justify-between">
              <div>
                <p className="font-mono text-xs uppercase tracking-[0.14em] text-accent">Phía sau bản redesign</p>
                <h2 className="mt-5 max-w-[10ch] text-[clamp(3rem,6vw,6rem)] font-semibold leading-[0.86] tracking-[-0.04em]">
                  Hiểu thêm về Nét Nút.
                </h2>
              </div>
              <Link
                href="/about"
