...
export function HeroAbout({ locale, copy }: HeroAboutProps) {
  return (
    <section
      id="about-hero"
        ...
        <div className="max-w-xl md:col-span-5 md:col-start-8 lg:col-span-4 lg:col-start-9">
          ...
          <div className="mt-8 flex flex-col items-start gap-3 sm:flex-row sm:items-center sm:gap-5">
            ...
            <Link
              ...
              className="text-sm leading-relaxed text-foreground/68 underline decoration-foreground/30 underline-offset-4 transition-colors hover:text-accent"
            >
              {copy.ctaSecondary}
            </Link>
          </div>
