      ...
      <div className="relative mx-auto w-full max-w-[1600px]">
        ...
        <div className="mt-10 grid gap-8 md:mt-14 md:grid-cols-12 md:items-end">
          ...
          <div data-hero-copy className="flex flex-col gap-3 sm:flex-row md:col-span-8 md:col-start-5 lg:col-span-7 lg:col-start-6">
            <a
              href="#contact"
              className="group inline-flex min-h-12 items-center justify-between gap-7 border border-foreground bg-foreground py-2 pl-5 pr-2 text-sm font-semibold text-[#090909] transition-transform duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] hover:-translate-y-1 active:scale-[0.98]"
            >
              Gửi website của bạn
            ...
            <a
              href="#work"
              className="inline-flex min-h-12 items-center justify-center border border-white/25 px-5 text-sm font-medium text-foreground transition-[border-color,transform] duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] hover:-translate-y-1 hover:border-accent active:scale-[0.98]"
            >
              Xem dự án
            </a>
          </div>
